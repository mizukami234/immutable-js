...
(function (global, factory) {
  ...
  function makeRecordType(proto, defaultValues, name) {
    ...
    var RecordTypePrototype = (RecordType.prototype = Object.create(proto));
  ...
  function extend(Origin, additionalDefaultValues, name) {
    ...
    var defaultValues = {};
    Object.entries(Origin.prototype._defaultValues).forEach(function (ref) {
      var k = ref[0];
      var v = ref[1];

      defaultValues[k] = v;
    });
    Object.entries(additionalDefaultValues).forEach(function (ref) {
      var k = ref[0];
      var v = ref[1];
